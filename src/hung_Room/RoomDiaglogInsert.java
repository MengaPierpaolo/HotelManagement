 ...
 * @author Admin
 */
public class RoomDiaglogInsert extends javax.swing.JDialog implements CentralInterface{
    ...
    public RoomDiaglogInsert(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        roomDAO = new RoomDAO();
        setComboboxModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RoomDiaglogInsert.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RoomDiaglogInsert dialog = new RoomDiaglogInsert(new javax.swing.JFrame(), true);
